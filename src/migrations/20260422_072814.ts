...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum__members_v_published_locale" AS ENUM('en');
  ...
  CREATE TABLE "_members_v" (
  	...
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"snapshot" boolean,
  	"published_locale" "enum__members_v_published_locale",
  	"latest" boolean,
  	"autosave" boolean
  );
  
  CREATE TABLE "_members_v_locales" (
  ...
  CREATE TABLE "pages_blocks_pullquote_locales" (
  	"quote" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" varchar NOT NULL
  ...
  CREATE TABLE "pages_blocks_two_col_locales" (
  	"left" jsonb,
  	"right" jsonb,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_pullquote_locales" (
  	"quote" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" integer NOT NULL
  ...
  CREATE TABLE "_pages_v_blocks_two_col_locales" (
  	"left" jsonb,
  	"right" jsonb,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_cta_band_locales" (
  	"label" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" integer NOT NULL
  ...
  CREATE TABLE "_pages_v_blocks_stats_grid_stats_locales" (
  	"label" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" integer NOT NULL
  ...
  CREATE TABLE "manifesto_pillars_pillars_locales" (
  	"title" varchar NOT NULL,
  ...
  CREATE TABLE "footer_colophon_locales" (
  ...
  CREATE TABLE "home_page_hero_keywords_locales" (
  	"word" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" varchar NOT NULL
  ...
  CREATE TABLE "home_page_cta_bands_locales" (
  	"label" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" varchar NOT NULL
  ...
  CREATE TABLE "_home_page_v_version_hero_keywords_locales" (
  	"word" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" integer NOT NULL
  ...
  CREATE TABLE "_home_page_v_version_cta_bands_locales" (
  	"label" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" integer NOT NULL
  ...
  ALTER TABLE "members_locales" ADD CONSTRAINT "members_locales_meta_image_id_media_id_fk" FOREIGN KEY ("meta_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_members_v_locales" ADD CONSTRAINT "_members_v_locales_version_meta_image_id_media_id_fk" FOREIGN KEY ("version_meta_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_members_v_locales" ADD CONSTRAINT "_members_v_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_members_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "pages_blocks_pullquote_locales" ADD CONSTRAINT "pages_blocks_pullquote_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_pullquote"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "pages_blocks_two_col_locales" ADD CONSTRAINT "pages_blocks_two_col_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_two_col"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_pullquote_locales" ADD CONSTRAINT "_pages_v_blocks_pullquote_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_pullquote"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_two_col_locales" ADD CONSTRAINT "_pages_v_blocks_two_col_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_two_col"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_cta_band_locales" ADD CONSTRAINT "_pages_v_blocks_cta_band_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_cta_band"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_stats_grid_stats_locales" ADD CONSTRAINT "_pages_v_blocks_stats_grid_stats_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_stats_grid_stats"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "manifesto_pillars_pillars_locales" ADD CONSTRAINT "manifesto_pillars_pillars_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."manifesto_pillars_pillars"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "footer_colophon_locales" ADD CONSTRAINT "footer_colophon_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."footer_colophon"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "home_page_hero_keywords_locales" ADD CONSTRAINT "home_page_hero_keywords_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."home_page_hero_keywords"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "home_page_cta_bands_locales" ADD CONSTRAINT "home_page_cta_bands_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."home_page_cta_bands"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_home_page_v_version_hero_keywords_locales" ADD CONSTRAINT "_home_page_v_version_hero_keywords_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_home_page_v_version_hero_keywords"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_home_page_v_version_cta_bands_locales" ADD CONSTRAINT "_home_page_v_version_cta_bands_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_home_page_v_version_cta_bands"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "members_meta_meta_image_idx" ON "members_locales" USING btree ("meta_image_id","_locale");
  ...
  CREATE INDEX "_members_v_snapshot_idx" ON "_members_v" USING btree ("snapshot");
  CREATE INDEX "_members_v_published_locale_idx" ON "_members_v" USING btree ("published_locale");
  ...
  CREATE INDEX "_members_v_version_meta_version_meta_image_idx" ON "_members_v_locales" USING btree ("version_meta_image_id","_locale");
  CREATE UNIQUE INDEX "_members_v_locales_locale_parent_id_unique" ON "_members_v_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE UNIQUE INDEX "pages_blocks_pullquote_locales_locale_parent_id_unique" ON "pages_blocks_pullquote_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE UNIQUE INDEX "pages_blocks_two_col_locales_locale_parent_id_unique" ON "pages_blocks_two_col_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE UNIQUE INDEX "_pages_v_blocks_pullquote_locales_locale_parent_id_unique" ON "_pages_v_blocks_pullquote_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE UNIQUE INDEX "_pages_v_blocks_two_col_locales_locale_parent_id_unique" ON "_pages_v_blocks_two_col_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE UNIQUE INDEX "_pages_v_blocks_cta_band_locales_locale_parent_id_unique" ON "_pages_v_blocks_cta_band_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE UNIQUE INDEX "_pages_v_blocks_stats_grid_stats_locales_locale_parent_id_un" ON "_pages_v_blocks_stats_grid_stats_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE UNIQUE INDEX "manifesto_pillars_pillars_locales_locale_parent_id_unique" ON "manifesto_pillars_pillars_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE UNIQUE INDEX "footer_colophon_locales_locale_parent_id_unique" ON "footer_colophon_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE UNIQUE INDEX "home_page_hero_keywords_locales_locale_parent_id_unique" ON "home_page_hero_keywords_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE UNIQUE INDEX "home_page_cta_bands_locales_locale_parent_id_unique" ON "home_page_cta_bands_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE UNIQUE INDEX "_home_page_v_version_hero_keywords_locales_locale_parent_id_" ON "_home_page_v_version_hero_keywords_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE UNIQUE INDEX "_home_page_v_version_cta_bands_locales_locale_parent_id_uniq" ON "_home_page_v_version_cta_bands_locales" USING btree ("_locale","_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "_members_v_locales" CASCADE;
  ...
  DROP TABLE "pages_blocks_pullquote_locales" CASCADE;
  DROP TABLE "pages_blocks_two_col" CASCADE;
  DROP TABLE "pages_blocks_two_col_locales" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_pullquote_locales" CASCADE;
  DROP TABLE "_pages_v_blocks_two_col" CASCADE;
  DROP TABLE "_pages_v_blocks_two_col_locales" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_cta_band_locales" CASCADE;
  DROP TABLE "_pages_v_blocks_stats_grid_stats" CASCADE;
  DROP TABLE "_pages_v_blocks_stats_grid_stats_locales" CASCADE;
  ...
  DROP TABLE "manifesto_pillars_pillars_locales" CASCADE;
  ...
  DROP TABLE "footer_colophon_locales" CASCADE;
  ...
  DROP TABLE "home_page_hero_keywords_locales" CASCADE;
  DROP TABLE "home_page_cta_bands" CASCADE;
  DROP TABLE "home_page_cta_bands_locales" CASCADE;
  DROP TABLE "home_page" CASCADE;
  DROP TABLE "home_page_locales" CASCADE;
  DROP TABLE "_home_page_v_version_hero_keywords" CASCADE;
  DROP TABLE "_home_page_v_version_hero_keywords_locales" CASCADE;
  DROP TABLE "_home_page_v_version_cta_bands" CASCADE;
  DROP TABLE "_home_page_v_version_cta_bands_locales" CASCADE;
  ...
  DROP TYPE "public"."enum__members_v_published_locale";
